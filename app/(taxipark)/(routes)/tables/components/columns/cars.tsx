...
// import { deleteCars } from "@/components/modals/delete-application";
...
export default function GetAllCars() {
    ...
    const [currentCars, setCurrentCars] =
      useState<Cars | null>(null);
    ...
    React.useEffect(() => {
      async function fetchDataCars() {
        try {
          ...
          const formattedCarsData = carsData.map(
            (car) => ({
              ...car,
              car: {
                id: car.id,
